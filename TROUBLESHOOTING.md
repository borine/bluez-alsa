...
## 6. Couldn't change BlueALSA PCM configuration: Input/output error
...
>>>>>>> 4a3c239 (Add Reconfigurable property to org.bluealsa.PCM1 interface)
```

## 7. Using BlueALSA alongside PulseAudio or PipeWire
...
## 8. ALSA thread-safe API (alsa-lib >= 1.1.2, <= 1.1.3)
