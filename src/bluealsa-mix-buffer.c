...
#define BLUEALSA_24BIT_MIN 0xFF800000
#define BLUEALSA_24BIT_MAX 0x007FFFFF

#if defined(__BYTE_ORDER) && defined(__LITTLE_ENDIAN) && \
	__BYTE_ORDER == __LITTLE_ENDIAN

#define BA_S24_4LE_TO_INT32(x) ((x & 0x00800000) ? x | 0xFF000000 : x)

#define BA_INT32_TO_S24_4LE(x) (((uint32_t)x & 0x80000000) >> 8) | ((uint32_t)x & 0x007FFFFF)
	...
	for (n = 0; n < count; n++) {
		...
		switch (buffer->format) {
			...
			case BA_TRANSPORT_PCM_FORMAT_S24_4LE: {
				...
				buffer->data.s32[base + n] += (int32_t)BA_S24_4LE_TO_INT32(ptr[n]);
				break;
			}
			case BA_TRANSPORT_PCM_FORMAT_S32_4LE: {
