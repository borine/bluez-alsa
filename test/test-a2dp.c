...
bool ba_pcm_multi_init(struct bluealsa_pcm_multi *multi, size_t transfer_samples) { (void) multi; (void) transfer_samples; return true; }
ssize_t ba_pcm_multi_read(struct bluealsa_pcm_multi *multi, void *buffer, size_t samples) { (void) multi; (void) buffer; (void) samples; return -1; }
ssize_t ba_pcm_multi_write(struct bluealsa_pcm_multi *multi, const void *buffer, size_t samples) { (void) multi; (void) buffer; (void) samples; return -1; }
